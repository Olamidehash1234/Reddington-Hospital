            ...
            <div className="relative bg-[#E40714] px-[16px] lg:px-[40px] py-[40px] lg:py-[80px] rounded-[20px] lg:rounded-[20px]">
                ...
                <div className="justify-center items-center text-center mb-[10px] lg:mb-[20px]">
                    ...
                    <div className="space-y-[20px] text-[#FFFFFF] justify-center items-center lg:space-y-[30px] text-[13px] lg:text-[16px] lg:leading-[24px] leading-[20px]">
                        ...
                        <p>
                           We went on to become the first healthcare facility of any description in Nigeria to be re-accredited at the very first attempt, following a rigorous audit in 2015. The process involves comprehensive evaluation of every aspect of our operations—from clinical procedures and infection control to patient safety protocols and staff training—against internationally benchmarked standards. Success at this level demands nothing less than total organisational commitment.
                        </p>

                        <p>
                            Today, we remain continuously accredited, with our most recent re-accreditation extending through to 2028. Yet we understand that the journey to excellence is never truly completed. Each day presents a fresh opportunity to refine our processes, enhance our facilities, and elevate the care we provide. At Reddington, the pursuit of quality is perpetual.
                        </p>
                    </div>
                </div>
            </div>
